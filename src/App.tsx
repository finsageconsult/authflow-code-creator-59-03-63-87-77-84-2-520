...
// Function to remove external chat widgets
const removeExternalChatWidgets = () => {
  // Remove elements containing "rohitsaw" text
  const elementsWithRohitsaw = document.querySelectorAll('*');
  elementsWithRohitsaw.forEach((element) => {
  ...
  // Remove common chat widget elements
