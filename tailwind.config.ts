...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				'dashboard-heading': ['2.5rem', { lineHeight: '1.2', fontWeight: '700' }],
				'dashboard-subheading': ['1.25rem', { lineHeight: '1.5', fontWeight: '600' }],
				'dashboard-body': ['0.875rem', { lineHeight: '1.6', fontWeight: '400' }],
			},
			colors: {
